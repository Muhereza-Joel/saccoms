                                ...
                                <div className="mt-4 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <InputLabel
                                            ...
                                            value="Maximum amount of money a member can borrow"
                                        />

                                        {/* Input Field for Loan Penalty */}
                                        <TextInput
                                            id="loan_plan_limit"
                                            name="loan_plan_limit"
                                            type="number"
                                            value={data.loan_plan_limit}
                                            className="mt-1 block w-full"
                                            isFocused={false}
                                            onChange={(e) =>
                                                setData(
                                            ...
                                            placeholder="Enter the maximum amount a member can borrow"
                                        />

                                        {/* Error Message for Loan Penalty */}
                                        <InputError
                                            message={errors.loan_plan_limit}
                                            className="mt-2"
                                        />
                                    </div>
